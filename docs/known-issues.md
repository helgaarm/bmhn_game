...
- Phase 2 exposes all nine campaign stages, but only Discover is playable. Understand and assess is active in campaign state after completion and is the next content increment.
...
- The isolated game route is approximately 3.17 MB minified / 1.09 MB gzip in the current production build, largely due to the 3D and physics runtime. The normal shell remains separate at approximately 236 kB / 76 kB gzip.
